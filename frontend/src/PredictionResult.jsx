...
import model1DiseaseData from './data/plant_disease_model1_expanded.json'
...
function PredictionResult({ prediction, isLoading, error, isEnglish }) {
  ...
  const diseaseNames = {
    ...
    'Sugarcane__bacterial_blight': {
      en: 'Sugarcane Bacterial Blight',
      mr: 'ऊस बॅक्टेरियल करपा'
    },
    'Sugarcane__healthy': {
      en: 'Sugarcane Healthy',
      mr: 'निरोगी ऊस'
    },
    'Sugarcane__red_rot': {
  ...
  const diseaseInfo = prediction.model_used === 'model1' 
    ? model1DiseaseData[prediction.class] || {
        description: {
    ...
    : diseaseSolutionsData[prediction.class] || {
        description: {
          en: getTranslation('noInfo'),
          mr: getTranslation('noInfo')
        },
